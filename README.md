...
More details on the models can be found in the README in the models folder, but they curerntly include the deeper VGG models (VGG16 and VGG19), and ResNets (currently ResNet18 and a very simple demo).